...
import DutchToken from "../chain-info/DutchToken.json"
...
export const Main = () => {
  ...
  const dutchTokenAddress = chainId ? networkMapping[String(chainId)]["DutchToken"][0] : constants.AddressZero
